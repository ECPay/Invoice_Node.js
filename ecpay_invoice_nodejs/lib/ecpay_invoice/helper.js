...
const testConfig = require(__dirname + "/../../conf/test_config.json");

class APIHelper {
    constructor(config = testConfig) {
        this.op_mode = config.OperatingMode;
        this.contractor_stat = config.IsProjectContractor || testConfig.IsProjectContractor;
        this.ignore_payment = config.IgnorePayment || testConfig.IgnorePayment;

        this.merc_id = config.MerchantID;
        this.hkey = config.HashKey;
        this.hiv = config.HashIV;
        this.date = new Date();
    }
    get_mercid() {
        return this.merc_id;
